...
class CreateAlumnosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('alumnos', function (Blueprint $table) {
            ...
            $table->foreign("nacionalidad_id")->references("id")->on("nacionalidades")->onDelete('set null');
            $table->foreign("departamento_nacimiento_id")->references("id")->on("departamentos")->onDelete('set null');
            $table->foreign("municipio_nacimiento_id")->references("id")->on("municipios")->onDelete('set null');
            ...
            $table->foreign("centro_providencia_id")->references("id")->on("centroescolares")->onDelete('set null');
            $table->integer("anio_anterior");
            $table->string("tipo_sangre");
            $table->char("sexo");
            $table->char("estado_familiar");
            $table->foreign("discapacidad_id")->references("id")->on("discapacidades")->onDelete('set null');
            $table->string("email");
            $table->string("telefeno");
            $table->foreign("zona_id")->references("id")->on("zonas")->onDelete('set null');
            $table->foreign("departamento_residencia_id")->references("id")->on("departamentos")->onDelete('set null');
            $table->foreign("canton_id")->references("id")->on("cantones")->onDelete('set null');
            $table->foreign("caserio_id")->references("id")->on("caserios")->onDelete('set null');
            $table->foreign("tipo_calle_id")->references("id")->on("calles")->onDelete('set null');
            ...
            $table->foreign("departamento_responsable_id")->references("id")->on("departamentos")->onDelete('set null');
            $table->foreign("municipio_responsable_id")->references("id")->on("municipios")->onDelete('set null');
            $table->foreign("canton_responsable_id")->references("id")->on("cantones")->onDelete('set null');
            $table->foreign("caserio_responsable_id")->references("id")->on("caserios")->onDelete('set null');
            $table->foreign("tipo_calle_responsable_id")->references("id")->on("calles")->onDelete('set null');
            ...
            $table->foreign("profesor_revision_id")->references("id")->on("profesores")->onDelete('set null');
            $table->timestamps();
        });
    }
